...
const allowed = [
  ...
  /^NOTICE$/,
  /^package\.json$/,
  /^schemas\/skill-card\.schema\.json$/,
  /^templates\/skill\/(?:SKILL\.md|BENCHMARK\.md|skill-card\.(?:md|json)|references\/README\.md)$/,
  /^tools\/(?:generate-catalog|validate-skills|validate-skill-cards|validate-skills-security|check-package-allowlist|install-smoke|lib)\.js$/,
